param(
    ...
    [string]$SosSource = 'C:\AMD-BC-250\AMD-BC-250-PSP-Windows-Driver\output\v3\sos.bin',
...
# Pad SOS to 256KB as driver expects
...
Write-Host ("SOS ({0}): {1} bytes (padded to 262144)" -f $LabelPrefix, $sosData.Length)
Write-Host ("SYSDRV ({0}): {1} bytes" -f $LabelPrefix, $sysdrvData.Length)
